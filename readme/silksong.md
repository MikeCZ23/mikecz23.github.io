...
<div class="stavpr prog-custom" style="display: flex; align-items: center; column-gap: 12px">
  ...
  <div class="progpr" style="flex: 1"><el-progress :percentage="98" :stroke-width="18" :text-inside="true" status="success" striped /></div>
</div>
<div class="stavpr prog-custom" style="display: flex; align-items: center; column-gap: 12px">
...
Napiš sem https://discord.gg/fDE5uDThnm. Hlavně loremasteři jestli smím prosit.<br>
